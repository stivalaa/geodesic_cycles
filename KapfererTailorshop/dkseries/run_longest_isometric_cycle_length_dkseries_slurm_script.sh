...
OBS_MAXISOMETRICCYCLE=kapferertailorshop_longest_isometric_cycle.txt
...
if [ ! -f $OBS_MAXISOMETRICCYCLE ]; then 
	...
	time python3 $SCRIPTDIR/longestIsometricCycle.py kapferertailorshop_edgelist.txt >> ${OBS_MAXISOMETRICCYCLE}
fi
