...
OBS_EDGELIST=kapferertailorshop_edgelist.txt

time Rscript $SCRIPTDIR/plotUndirectedSimFit.R $OBS_EDGELIST "../statnet_estimations/simulated/model2/sim_model2_*_edgelist.txt" statnet_model2_simfit_gof.pdf
