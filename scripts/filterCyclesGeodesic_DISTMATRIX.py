...
def isCycleGeodesic(g, distmatrix, cycle):
    """
    ...
    graph_dists = [distmatrix[u][v] for (u, v) in nodepairs]
...
def main():
    ...
    # not actually a matrix, but a Python list of lists
    distmatrix = g.shortest_paths()
