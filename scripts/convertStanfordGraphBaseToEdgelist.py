...
#
# File:    convertStanfordGraphBaseToEdgelist.py
# Author:  Alex Stivala
# Created: August 2019
#
##############################################################################
...
Usage:
   convertStanfordGraphBaseToEdgelist.py infile 

      infile - filename of .sgb file to read

   Output is to stdout in zero-based edgelist format
