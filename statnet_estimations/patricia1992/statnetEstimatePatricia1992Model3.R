#!/usr/bin/env Rscript
###
### File:    statnetEstimatePatricia1992Model3.R
### Author:  Alex Stivala
### Created: July 2019
###
...
###
### Usage: statnetEstimatePatricia1992Model3.R
###
###
### Model and GoF output is to stdout, also writes output files to cwd:
###   'patricia1992_statnet_model3.txt'
###   'patricia1992_statnet_model3_mcmcdiagnostics.eps'
###   'patricia1992_statnet_model3_gof.eps'
...
postscript('patricia1992_statnet_model3_mcmcdiagnostics.eps')
mcmc.diagnostics(model3)
dev.off()

sink('patricia1992_statnet_model3.txt')
...
print(model3_gof)
postscript('patricia1992_statnet_model3_gof.eps')
par(mfrow=c(3,3))
plot( model3_gof)
dev.off()
