#!/usr/bin/env Rscript
###
### File:    statnetEstimatePatricia1993Model1.R
### Author:  Alex Stivala
### Created: July 2019
###
...
###
### Usage: statnetEstimatePatricia1993Model1.R
###
###
### Model and GoF output is to stdout, also writes output files to cwd:
###   'patricia1993_statnet_model1.txt'
###   'patricia1993_statnet_model1_mcmcdiagnostics.eps'
###   'patricia1993_statnet_model1_gof.eps'
...
postscript('patricia1993_statnet_model1_mcmcdiagnostics.eps')
mcmc.diagnostics(model1)
dev.off()

sink('patricia1993_statnet_model1.txt')
...
print(model1_gof)
postscript('patricia1993_statnet_model1_gof.eps')
par(mfrow=c(3,3))
plot( model1_gof)
dev.off()
