...
OBS_EDGELIST=patricia1993_edgelist.txt

time Rscript $SCRIPTDIR/plotUndirectedSimFit.R $OBS_EDGELIST "simulated/model1/sim_model1_*_edgelist.txt" statnet_model1_simfit_gof.pdf
