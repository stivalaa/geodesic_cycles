...
#SBATCH --job-name="longest_isometric_model4"
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=0-1:00:00
#SBATCH --output=longest_isometric_model4-%j.out
#SBATCH --error=longest_isometric_model4-%j.err
...
MAXISOMETRICTAB=model4_longest_isometric_cycle.txt
...
if [ ! -f $MAXISOMETRICTAB ]; then 
	time $SCRIPTDIR/makeLongestISometricCycleLengthTables.sh simulated/model4/ > ${MAXISOMETRICTAB}
fi
