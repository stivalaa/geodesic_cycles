...
OBS_MAXISOMETRICCYCLE=patricia1990_longest_isometric_cycle.txt
...
if [ ! -f $OBS_MAXISOMETRICCYCLE ]; then 
	...
	time python3 $SCRIPTDIR/longestIsometricCycle.py patricia1990_edgelist.txt >> ${OBS_MAXISOMETRICCYCLE}
fi
