...
OBS_GEODESICCYCLETAB=anna_geodesiccycletable.txt
...
if [ ! -f $OBS_GEODESICCYCLETAB ]; then 
	...
	time $SCRIPTDIR/makeSingleNetworkGeodesicCycleLengthDistributionTable.sh anna_edgelist.txt > ${OBS_GEODESICCYCLETAB}
fi
