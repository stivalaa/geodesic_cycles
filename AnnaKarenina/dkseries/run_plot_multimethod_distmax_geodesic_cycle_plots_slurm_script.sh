...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' "" "dk*_geodesiccycledisttable.txt" anna_geodesiccycletable.txt  "" "dk*_longest_isometric_cycle.txt" anna_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" anna_combined_max_geodesic_multimodels_distmax.eps
