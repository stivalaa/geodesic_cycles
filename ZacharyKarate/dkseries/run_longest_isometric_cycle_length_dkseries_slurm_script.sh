...
OBS_MAXISOMETRICCYCLE=zacharykarateclub_longest_isometric_cycle.txt
...
if [ ! -f $OBS_MAXISOMETRICCYCLE ]; then 
	...
	time python3 $SCRIPTDIR/longestIsometricCycle.py zacharykarateclub_edgelist.txt >> ${OBS_MAXISOMETRICCYCLE}
fi
