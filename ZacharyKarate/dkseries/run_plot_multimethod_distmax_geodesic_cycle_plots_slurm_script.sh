...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' ../statnet_estimations/model2_geodesiccycledisttable.txt "dk*_geodesiccycledisttable.txt" zachary_karateclub_geodesiccycletable.txt  ../statnet_estimations/model2_longest_isometric_cycle.txt "dk*_longest_isometric_cycle.txt" zacharykarateclub_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" zachary_karateclub_combined_max_geodesic_multimodels_distmax.eps
