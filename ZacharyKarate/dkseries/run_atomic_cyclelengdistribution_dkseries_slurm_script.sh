...
OBS_ATOMICCYCLETAB=zacharykarateclub_atomiccycletable.txt
...
if [ ! -f $OBS_ATOMICCYCLETAB ]; then 
	time $SCRIPTDIR/makeSingleNetworkAtomicCycleLengthDistributionTable.sh zacharykarateclub_edgelist.txt > ${OBS_ATOMICCYCLETAB}
fi
