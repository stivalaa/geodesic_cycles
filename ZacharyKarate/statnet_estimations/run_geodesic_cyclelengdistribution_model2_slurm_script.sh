...
OBS_GEODESICCYCLETAB=zachary_karateclub_geodesiccycletable.txt
...
if [ ! -f $OBS_GEODESICCYCLETAB ]; then 
	time $SCRIPTDIR/makeSingleNetworkGeodesicCycleLengthDistributionTable.sh zachary_karateclub_edgelist.txt > ${OBS_GEODESICCYCLETAB}
fi
