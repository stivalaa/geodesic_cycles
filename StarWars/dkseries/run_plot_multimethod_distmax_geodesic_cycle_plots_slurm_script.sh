...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' "" "dk*_geodesiccycledisttable.txt" starwars_geodesiccycletable.txt  "" "dk*_longest_isometric_cycle.txt" starwars_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" starwars_combined_max_geodesic_multimodels_distmax.eps
