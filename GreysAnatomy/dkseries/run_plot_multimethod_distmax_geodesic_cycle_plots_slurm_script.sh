...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' ../statnet_estimations/model5_geodesiccycledisttable.txt "dk*_geodesiccycledisttable.txt" greysanatomy_geodesiccycletable.txt  ../statnet_estimations/model5_longest_isometric_cycle.txt "dk*_longest_isometric_cycle.txt" greysanatomy_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" greysanatomy_combined_max_geodesic_multimodels_distmax.eps
