...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' ../statnet_estimations/model1_geodesiccycledisttable.txt "dk*_geodesiccycledisttable.txt" dolphins_geodesiccycletable.txt  ../statnet_estimations/model1_longest_isometric_cycle.txt "dk*_longest_isometric_cycle.txt" dolphins_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" dolphins_combined_max_geodesic_multimodels_distmax.eps
