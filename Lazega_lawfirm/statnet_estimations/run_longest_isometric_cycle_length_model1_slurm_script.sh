...
OBS_MAXISOMETRICCYCLE=lazega_lawfirm_friendship_longest_isometric_cycle.txt
...
if [ ! -f $OBS_MAXISOMETRICCYCLE ]; then 
	...
	time python3 $SCRIPTDIR/longestIsometricCycle.py lazega_lawfirm_friendship_edgelist.txt >> ${OBS_MAXISOMETRICCYCLE}
fi
