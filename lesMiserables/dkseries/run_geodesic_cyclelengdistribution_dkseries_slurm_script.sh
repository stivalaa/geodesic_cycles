...
OBS_GEODESICCYCLETAB=lesmis_geodesiccycletable.txt
...
if [ ! -f $OBS_GEODESICCYCLETAB ]; then 
	...
	time $SCRIPTDIR/makeSingleNetworkGeodesicCycleLengthDistributionTable.sh lesmis_edgelist.txt > ${OBS_GEODESICCYCLETAB}
fi
