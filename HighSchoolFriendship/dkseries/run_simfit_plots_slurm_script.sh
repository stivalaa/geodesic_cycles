...
OBS_EDGELIST=highschoolfriendship_edgelist.txt

time Rscript $SCRIPTDIR/plotUndirectedSimFit.R $OBS_EDGELIST "../statnet_estimations/simulated/model3/sim_model3_*_edgelist.txt" statnet_model3_simfit_gof.pdf
