...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' ../statnet_estimations/model2_geodesiccycledisttable.txt "dk*_geodesiccycledisttable.txt" highschoolfriendship_geodesiccycletable.txt  ../statnet_estimations/model2_longest_isometric_cycle.txt "dk*_longest_isometric_cycle.txt" highschoolfriendship_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" highschoolfriendship_combined_max_geodesic_multimodels_distmax.eps
