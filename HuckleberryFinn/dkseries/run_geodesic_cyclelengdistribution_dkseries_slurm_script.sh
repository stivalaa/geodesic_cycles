...
OBS_GEODESICCYCLETAB=huck_geodesiccycletable.txt
...
if [ ! -f $OBS_GEODESICCYCLETAB ]; then 
	...
	time $SCRIPTDIR/makeSingleNetworkGeodesicCycleLengthDistributionTable.sh huck_edgelist.txt > ${OBS_GEODESICCYCLETAB}
fi
