...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' "" "dk*_geodesiccycledisttable.txt" huck_geodesiccycletable.txt  "" "dk*_longest_isometric_cycle.txt" huck_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" huck_combined_max_geodesic_multimodels_distmax.eps
