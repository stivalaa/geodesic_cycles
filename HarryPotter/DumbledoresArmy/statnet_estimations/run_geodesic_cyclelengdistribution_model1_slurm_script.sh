...
OBS_GEODESICCYCLETAB=dumbledoresarmy_geodesiccycletable.txt
...
if [ ! -f $OBS_GEODESICCYCLETAB ]; then 
	...
	time $SCRIPTDIR/makeSingleNetworkGeodesicCycleLengthDistributionTable.sh ../dkseries/dumbledoresarmy_edgelist.txt > ${OBS_GEODESICCYCLETAB}
fi
