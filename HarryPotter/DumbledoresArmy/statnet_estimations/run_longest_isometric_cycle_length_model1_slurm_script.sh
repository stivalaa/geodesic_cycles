...
OBS_MAXISOMETRICCYCLE=dumbledoresarmy_longest_isometric_cycle.txt
...
if [ ! -f $OBS_MAXISOMETRICCYCLE ]; then 
	...
	time python3 $SCRIPTDIR/longestIsometricCycle.py ../dkseries/dumbledoresarmy_edgelist.txt >> ${OBS_MAXISOMETRICCYCLE}
fi
