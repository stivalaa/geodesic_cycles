...
time Rscript ${SCRIPTDIR}/plotCombinedMaxCycleLengthDistributionsFromTablesMultiMethodsDistMax.R 'geodesic cycle' "../statnet_estimations/model?_geodesiccycledisttable.txt" "dk*_geodesiccycledisttable.txt" harrypotter_geodesiccycletable.txt  "../statnet_estimations/model?_longest_isometric_cycle.txt" "dk*_longest_isometric_cycle.txt" harrypotter_longest_isometric_cycle.txt "countGeodesicCycles" "longestIsometricCycle" harrypotter_combined_max_geodesic_multimodels_distmax.eps
